...
// Rastreia obtem os tracking na api de rastro dos correios
...
// RastreiaAsync registra um grande volume de objetos para obtenção do tracking
// de maneira assincrona. Após obtidos os recibos, os mesmos devem ser consultados
// para obtenção do tracking dos objetos
...
//Recibo verifica o resultado os recibos de objetos registrados com a função RastreiaAsync
...
//LeArquivo obtem uma lista de tamanho indefinido de objetos. Cada objeto deverá estar em uma linha
//e o caracter de terminação de linha dever ser '\n'
